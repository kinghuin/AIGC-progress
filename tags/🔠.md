...
|------------|---------|-------|-------------|-------------|
| 2023-09-01 | [ppl.nn.llm](https://github.com/openppl-public/ppl.nn.llm) | 33 | 🔠 💡  |  |
...
| 2023-08-28 | [ChatDev](https://github.com/OpenBMB/ChatDev) | 300 | 🔠 🔨 `Python`  | Create Customized Software with Natural Language Ideas |
...
| 2023-08-25 | [code-llama-for-vscode](https://github.com/xNul/code-llama-for-vscode) | 191 | 🔠 🔨 `Python`  | Use Code Llama with Visual Studio Code and the Continue extension. A local LLM alternative to GitHub Copilot. |
| 2023-08-25 | [fastcodellama](https://github.com/yueliu1999/fastcodellama) | 36 | 🔠 🔨 `Python`  | Self-Acceleration of CodeLlama for Code Generation |
...
| 2023-08-24 | [eastworld](https://github.com/mluogh/eastworld) | 50 | 🔠 🔨 `TypeScript`  | Framework for Generative Agents in Games |
...
| 2023-08-23 | [Lemur](https://github.com/OpenLemur/Lemur) | 170 | 🔠 🚌  | Lemur: The State-of-the-art Open Pretrained Large Language Models Balancing Text and Code Capabilities |
...
| 2023-08-23 | [wechat-ai-summarize-bot](https://github.com/aoao-eth/wechat-ai-summarize-bot) | 175 | 🔠 🔨 `TypeScript`  | 微信群聊总结助手 Nodejs 版 |
| 2023-08-23 | [PIPE](https://github.com/jthack/PIPE) | 146 | 🔠 📝  | Prompt Injection Primer for Engineers |
| 2023-08-23 | [plotai](https://github.com/mljar/plotai) | 180 | 🔠 🔨 `Python`  | PlotAI - Your Ultimate Plotting Assistant! 📊🤖 Use ChatGPT-3.5 to create plots in Python and Matplotlib directly in your Python script or notebook.  |
| 2023-08-23 | [gpt-auto-tuner-web-ui](https://github.com/ryanxjhan/gpt-auto-tuner-web-ui) | 7 | 🔠 🔨 `Python`  | Fine-tune GPT3.5 and chat with your trained model in a few clicks. |
| 2023-08-22 | [OmniQuant](https://github.com/OpenGVLab/OmniQuant) | 104 | 🔠 💡  | OmniQuant is a simple and powerful quantization technique for LLMs.  |
| 2023-08-22 | [PerroPastor](https://github.com/alvion427/PerroPastor) | 24 | 🔠 🔨 `C#`  | Run Llama based LLMs in Unity entirely in compute shaders with no dependencies |
| 2023-08-22 | [Awesome-AIGC-Tutorials](https://github.com/luban-agi/Awesome-AIGC-Tutorials) | 513 | 🔠 📝  | Awesome AIGC Tutorials houses a curated collection of tutorials and resources spanning across Large Language Models, AI Painting, and related fields. |
| 2023-08-21 | [AutoAgents](https://github.com/LinkSoul-AI/AutoAgents) | 65 | 🔠 🔨 `Python`  | Generate different roles for GPTs to form a collaborative entity for complex tasks. |
...
| 2023-08-20 | [lagent](https://github.com/InternLM/lagent) | 295 | 🔠 🔨 `Python`  | A lightweight framework for building LLM-based agents |
| 2023-08-20 | [shell-ai](https://github.com/ricklamers/shell-ai) | 768 | 🔠 🔨 `Python`  | LangChain powered shell command generate and run CLI |
...
| 2023-08-18 | [graph-of-thoughts](https://github.com/spcl/graph-of-thoughts) | 1021 | 🔠 🔨 `Python`  | Official Implementation of "Graph of Thoughts: Solving Elaborate Problems with Large Language Models" |
| 2023-08-17 | [llama-terminal-completion](https://github.com/adammpkins/llama-terminal-completion) | 70 | 🔠 🔨 `Python`  | A Python application which interacts with the llama.cpp library to provide virtual assistant capabilities through the command line. It allows you to ask questions and receive intelligent responses, as well as generate Linux commands based on your prompts. |
| 2023-08-17 | [sqlcoder](https://github.com/defog-ai/sqlcoder) | 1160 | 🔠 🚕  | SoTA LLM for converting natural language questions to SQL queries |
...
| 2023-08-16 | [gpt-pilot](https://github.com/Pythagora-io/gpt-pilot) | 1997 | 🔠 🔨 `Python`  | GPT Pilot can code out the entire app as you oversee the code being written |
...
| 2023-07-25 | [AI-Code-Convert](https://github.com/JustAIGithub/AI-Code-Convert) | 253 | 🔠 🔨 `TypeScript`  | AI Code Translator \| AI Code Converter \| AI Code Generator，Generate Code or Natural Language To Programming Language |
...
| 2023-06-22 | [companion-app](https://github.com/a16z-infra/companion-app) | 5259 | 🔠 🔨 `TypeScript`  | AI companions with memory: a lightweight stack to create and host your own AI companions |
...
| 2023-05-08 | [InternGPT](https://github.com/OpenGVLab/InternGPT) | 2850 | 🔠 🔨 `Python`  | InternGPT (iGPT) is an open source demo platform where you can easily showcase your AI models. Now it supports DragGAN, ChatGPT, ImageBind, multimodal chat like GPT-4, SAM, interactive image editing, etc. Try it at igpt.opengvlab.com (支持DragGAN、ChatGPT、ImageBind、SAM的在线Demo系统) |
...
| 2023-05-06 | [Chatbase](https://github.com/Anil-matcha/Chatbase) | 373 | 🔠 🔨 `Python`  | ChatGPT for every website.Instantly answer your visitors' questions with a personalized chatbot trained on your website content. Alternative to Chatbase, SiteGPT, Dante AI |
...
| 2023-05-06 | [simpleaichat](https://github.com/minimaxir/simpleaichat) | 2706 | 🔠 🔨 `Python`  | Python package for easily interfacing with chat apps, with robust features and minimal code complexity. |
| 2023-05-06 | [LangGPT](https://github.com/yzfly/LangGPT) | 1648 | 🔠 🔨 `Python`  | LangGPT: Empowering everyone to become a prompt expert!🚀  Structured Prompt，结构化提示词。 |
...
| 2023-05-05 | [RWKV-Runner](https://github.com/josStorer/RWKV-Runner) | 2588 | 🔠 🔨 `TypeScript`  | A RWKV management and startup tool, full automation, only 8MB. And provides an interface compatible with the OpenAI API. RWKV is a large language model that is fully open source and available for commercial use. |
...
| 2023-05-04 | [gpt4free-ts](https://github.com/xiangsx/gpt4free-ts) | 6374 | 🔠 ❓  | Providing a free OpenAI GPT-4 API !   This is a replication project for the typescript version of xtekky/gpt4free |
| 2023-05-03 | [Dromedary](https://github.com/IBM/Dromedary) | 969 | 🔠 🚌 2️⃣  | Dromedary: towards helpful, ethical and reliable LLMs. |
| 2023-05-03 | [go-proxy-bingai](https://github.com/adams549659584/go-proxy-bingai) | 7929 | 🔠 🔨 `HTML`  | 用 Vue3 和 Go 搭建的微软 New Bing 演示站点，拥有一致的 UI 体验，支持 ChatGPT 提示词，国内可用。 |
...
| 2023-05-03 | [ChatGPTAuthHelper](https://github.com/pengzhile/ChatGPTAuthHelper) | 596 | 🔠 🔨 `CSS`  | A simple Chrome extension to help you login ChatGPT. |
...
| 2023-05-02 | [privateGPT](https://github.com/imartinez/privateGPT) | 36962 | 🔠 🔨 `Python`  | Interact privately with your documents using the power of GPT, 100% privately, no data leaks |
...
| 2023-05-02 | [workgpt](https://github.com/team-openpm/workgpt) | 635 | 🔠 🔨 `TypeScript`  | A GPT agent framework for invoking APIs |
| 2023-05-01 | [LLMsNineStoryDemonTower](https://github.com/km1994/LLMsNineStoryDemonTower) | 780 | 🔠 📝  | 【LLMs九层妖塔】分享 LLMs在自然语言处理（ChatGLM、Chinese-LLaMA-Alpaca、小羊驼 Vicuna、LLaMA、GPT4ALL等）、信息检索（langchain）、语言合成、语言识别、多模态等领域（Stable Diffusion、MiniGPT-4、VisualGLM-6B、Ziya-Visual等）等 实战与经验。 |
...
| 2023-04-29 | [gpt-engineer](https://github.com/AntonOsika/gpt-engineer) | 42297 | 🔠 🔨 `Python`  | Specify what you want it to build, the AI asks for clarification, and then builds it. |
| 2023-04-29 | [mlc-llm](https://github.com/mlc-ai/mlc-llm) | 12447 | 🔠 💡  | Enable everyone to develop, optimize and deploy AI models natively on everyone's devices. |
| 2023-04-28 | [chatgpt-plugin](https://github.com/cloudflare/chatgpt-plugin) | 280 | 🔠 🔌  | Build ChatGPT plugins with Cloudflare's Developer Platform 🤖 |
...
| 2023-04-28 | [prompt-engineering-for-developers](https://github.com/datawhalechina/prompt-engineering-for-developers) | 6324 | 🔠 📝  | 面向开发者的 LLM 入门教程，吴恩达大模型系列课程中文版 |
...
| 2023-04-28 | [promptfoo](https://github.com/promptfoo/promptfoo) | 736 | 🔠 ❓  | Test your prompts. Evaluate and compare LLM outputs, catch regressions, and improve prompt quality. |
...
| 2023-04-26 | [ChatGPT-Admin-Web](https://github.com/AprilNEA/ChatGPT-Admin-Web) | 2485 | 🔠 🔨 `TypeScript`  | 带有用户管理和后台管理系统的 ChatGPT WebUI |
| 2023-04-26 | [chatgpt-web-plus](https://github.com/Chanzhaoyu/chatgpt-web-plus) | 785 | 🔠 🔨  | chatgpt-web-plus |
| 2023-04-26 | [OpenBuddy](https://github.com/OpenBuddy/OpenBuddy) | 878 | 🔠 🚌 🀄  | Open Multilingual Chatbot for Everyone |
| 2023-04-26 | [anse](https://github.com/anse-app/anse) | 1408 | 🔠 🔨 `TypeScript`  | Supercharged experience for ChatGPT, DALL-E and Stable Diffusion. |
...
| 2023-04-25 | [ChatGpt-Web](https://github.com/79E/ChatGpt-Web) | 939 | 🔠 🔨 `TypeScript`  | A commercially-viable ChatGpt web application built with React. 使用React搭建的一款可商业化的ChatGpt Web应用。 |
...
| 2023-04-25 | [RasaGPT](https://github.com/paulpierre/RasaGPT) | 1818 | 🔠 🔨 `Python`  | 💬 RasaGPT is the first headless LLM chatbot platform built on top of Rasa and Langchain. Built w/ Rasa, FastAPI, Langchain, LlamaIndex, SQLModel, pgvector, ngrok, telegram |
...
| 2023-04-25 | [Chrome-GPT](https://github.com/richardyc/Chrome-GPT) | 1257 | 🔠 🔨 `Python`  | An AutoGPT agent that controls Chrome on your desktop |
| 2023-04-24 | [word-GPT-Plus](https://github.com/Kuingsmile/word-GPT-Plus) | 316 | 🔠 🔨 `Vue`  | Word GPT Plus is a word add-in which integrates the chatGPT model into Microsoft Word. Both official and web api is supported. |
| 2023-04-24 | [starcoder](https://github.com/bigcode-project/starcoder) | 6218 | 🔠 ⛽ 🚕 2️⃣  | Home of StarCoder: fine-tuning & inference! |
| 2023-04-24 | [SalesGPT](https://github.com/filip-michalsky/SalesGPT) | 966 | 🔠 🔨 `Python`  | Context-aware AI Sales Agent to automate sales outreach. |
| 2023-04-24 | [wonderful-prompts](https://github.com/yzfly/wonderful-prompts) | 946 | 🔠 📝  | 🔥中文 prompt 精选🔥，ChatGPT 使用指南，提升 ChatGPT 可玩性和可用性！🚀 |
| 2023-04-23 | [LearnPrompt](https://github.com/LearnPrompt/LearnPrompt) | 571 | 🔠 📝  | 永久免费开源的 AIGC 课程, 目前已支持 ChatGPT, Midjourney, Runway, Stable Diffusion, AI数字人，AI声音&音乐，大模型微调 |
| 2023-04-23 | [LLMsPracticalGuide](https://github.com/Mooler0410/LLMsPracticalGuide) | 6208 | 🔠 📝  | A curated list of practical guide resources of LLMs (LLMs Tree, Examples, Papers) |
...
| 2023-04-23 | [vercel-reverse-proxy](https://github.com/gaboolic/vercel-reverse-proxy) | 649 | 🔠 🔨  | vercel反向代理\|OpenAI/ChatGPT 免翻墙代理\|github免翻墙代理\|github下载加速\|google代理\|vercel万能代理 |
| 2023-04-23 | [NewBingGoGo-Web](https://github.com/jianjianai/NewBingGoGo-Web) | 679 | 🔠 🔨 `JavaScript`  | 一个基于微软OpenAI ChatGPT GPT4的New Bing接口的Web服务。 提供了好看的对话页面。 实现了微软New Bing的大多数功能，还添加了一些自己的特色功能。 开源免费。 |
...
| 2023-04-23 | [chart-gpt](https://github.com/whoiskatrin/chart-gpt) | 3246 | 🔠 🔨 `TypeScript`  | AI tool to build charts based on text input |
...
| 2023-04-22 | [one-api](https://github.com/songquanpeng/one-api) | 3608 | 🔠 🔨 `Go`  | OpenAI 接口管理 & 分发系统，支持 Azure、Anthropic Claude、Google PaLM 2、智谱 ChatGLM、百度文心一言、讯飞星火认知、阿里通义千问以及 360 智脑，可用于二次分发管理 key，仅单可执行文件，已打包好 Docker 镜像，一键部署，开箱即用. OpenAI key management & redistribution system, using a single API for all LLMs, and features an English UI. |
| 2023-04-21 | [Camel-AutoGPT](https://github.com/SamurAIGPT/Camel-AutoGPT) | 1005 | 🔠 🔨 `JavaScript`  | 🚀 Introducing 🐪 CAMEL: a game-changing role-playing approach for LLMs and auto-agents like BabyAGI & AutoGPT! Watch two agents 🤝 collaborate and solve tasks together, unlocking endless possibilities in #ConversationalAI, 🎮 gaming, 📚 education, and more! 🔥 |
| 2023-04-21 | [prompt-engineering](https://github.com/brexhq/prompt-engineering) | 6916 | 🔠 📝  | Tips and tricks for working with Large Language Models like OpenAI's GPT-4. |
| 2023-04-21 | [openai](https://github.com/itamargol/openai) | 313 | 🔠 🔨 `Python`  | LLMs Best Tricks |
| 2023-04-21 | [law-cn-ai](https://github.com/lvwzhen/law-cn-ai) | 4449 | 🔠 ⛽ 🔨 🀄 `MDX`  | ⚖️ AI 法律助手 |
...
| 2023-04-21 | [awesome-chatgpt-dataset](https://github.com/voidful/awesome-chatgpt-dataset) | 526 | 🔠 ⛽ 📝  | Unlock the Power of LLM: Explore These Datasets to Train Your Own ChatGPT! |
...
| 2023-04-20 | [lamini](https://github.com/lamini-ai/lamini) | 2161 | 🔠 ⛽  |  |
| 2023-04-20 | [babyagi-ui](https://github.com/miurla/babyagi-ui) | 1080 | 🔠 🔨 `TypeScript`  | BabyAGI UI is designed to make it easier to run and develop with babyagi in a web app, like a ChatGPT. |
| 2023-04-20 | [chatglm-openai-api](https://github.com/ninehills/chatglm-openai-api) | 490 | 🔠 🔨 `Python`  | Provide OpenAI style API for  ChatGLM-6B and Chinese Embeddings Model |
...
| 2023-04-20 | [VLog](https://github.com/showlab/VLog) | 401 | 🔠 🎥 🔨 `Python`  | Transform Video as a Document with ChatGPT, CLIP, BLIP2, GRIT, Whisper, LangChain. |
...
| 2023-04-19 | [Ask-Anything](https://github.com/OpenGVLab/Ask-Anything) | 2121 | 🔠 🎥 🔨 `Python`  | [VideoChatGPT] ChatGPT with video understanding! And many more supported LMs such as miniGPT4, StableLM, and MOSS. |
...
| 2023-04-19 | [OpenLLM](https://github.com/bentoml/OpenLLM) | 5826 | 🔠 💡  | Operating LLMs in production |
...
| 2023-04-18 | [NeMo-Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) | 2073 | 🔠 🔨 `Python`  | NeMo Guardrails is an open-source toolkit for easily adding programmable guardrails to LLM-based conversational systems. |
| 2023-04-18 | [Auto-GPT-ZH](https://github.com/kaqijiang/Auto-GPT-ZH) | 2261 | 🔠 🔨 🀄 `Python`  | Auto-GPT中文版本及爱好者组织 同步更新原项目 AI领域创业 自媒体组织 用AI工作学习创作变现 |
| 2023-04-18 | [vault-ai](https://github.com/pashpashpash/vault-ai) | 3034 | 🔠 🔨 `JavaScript`  | OP Vault ChatGPT: Give ChatGPT long-term memory using the OP Stack (OpenAI + Pinecone Vector Database). Upload your own custom knowledge base files (PDF, txt, epub, etc) using a simple React frontend. |
| 2023-04-18 | [chatgpt-clone](https://github.com/xtekky/chatgpt-clone) | 3090 | 🔠 🔨 `Python`  | ChatGPT interface with better UI  |
| 2023-04-17 | [AGiXT](https://github.com/Josh-XT/AGiXT) | 1986 | 🔠 🔨 `Python`  | AGiXT is a dynamic AI Automation Platform that seamlessly orchestrates instruction management and complex task execution across diverse AI providers. Combining adaptive memory, smart features, and a versatile plugin system, AGiXT delivers efficient and comprehensive AI solutions. |
...
| 2023-04-17 | [Chinese-LangChain](https://github.com/yanqiangmiffy/Chinese-LangChain) | 2199 | 🔠 🔨 `Python`  | 中文langchain项目\|小必应，Q.Talk，强聊，QiangTalk |
| 2023-04-16 | [hyperDB](https://github.com/jdagdelen/hyperDB) | 1238 | 🔠 🔨 `Python`  | A hyper-fast local vector database for use with LLM Agents. Now accepting SAFEs at $135M cap. |
| 2023-04-15 | [AutoGPT-Next-Web](https://github.com/ConnectAI-E/AutoGPT-Next-Web) | 2455 | 🔠 🔨 `TypeScript`  | 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser.一键免费部署你的私人AutoGPT 网页应用 |
...
| 2023-04-15 | [show-me-chatgpt-plugin](https://github.com/bra1nDump/show-me-chatgpt-plugin) | 576 | 🔠 🔌  | Create and edit diagrams in ChatGPT |
...
| 2023-04-15 | [ai-brainstore](https://github.com/mckaywrigley/ai-brainstore) | 635 | 🔠 🔨 `TypeScript`  | A proof-of-concept of a brain for an AI agent. |
...
| 2023-04-14 | [auto-evaluator](https://github.com/rlancemartin/auto-evaluator) | 901 | 🔠 🔨 `Python`  | Evaluation tool for LLM QA chains |
| 2023-04-14 | [llama-lab](https://github.com/run-llama/llama-lab) | 873 | 🔠 🔨 `Python`  | Llama Lab is a repo dedicated to building cutting-edge projects using LlamaIndex. |
| 2023-04-14 | [superpower-chatgpt](https://github.com/saeedezzati/superpower-chatgpt) | 1078 | 🔠 🔨 `JavaScript`  | ChatGPT with superpowers! Search chat history, create folders, export all chats, pin messages, access thousands of community prompts, incognito mode, language and tone selection, and many more features |
| 2023-04-14 | [RedPajama-Data](https://github.com/togethercomputer/RedPajama-Data) | 3435 | 🔠 ⛽  | The RedPajama-Data repository contains code for preparing large datasets for training large language models. |
...
| 2023-04-13 | [DB-GPT](https://github.com/eosphoros-ai/DB-GPT) | 6271 | 🔠 🔨 `Python`  | Revolutionizing Database Interactions with Private LLM Technology |
| 2023-04-13 | [web-llm](https://github.com/mlc-ai/web-llm) | 7220 | 🔠 💡  | Bringing large-language models and chat to web browsers. Everything runs inside the browser with no server support. |
| 2023-04-13 | [prm800k](https://github.com/openai/prm800k) | 958 | 🔠 ⛽  | 800,000 step-level correctness labels on LLM solutions to MATH problems |
...
| 2023-04-11 | [smartgpt](https://github.com/Cormanz/smartgpt) | 1599 | 🔠 🔨 `Rust`  | A program that provides LLMs with the ability to complete complex tasks using plugins. |
| 2023-04-11 | [hugging-llm](https://github.com/datawhalechina/hugging-llm) | 1759 | 🔠 📝  | HuggingLLM, Hugging Future. |
...
| 2023-04-10 | [LangChain-ChatGLM-Webui](https://github.com/thomas-yanxin/LangChain-ChatGLM-Webui) | 2150 | 🔠 🔨 `Python`  | 基于LangChain和ChatGLM-6B等系列LLM的针对本地知识库的自动问答 |
...
| 2023-04-09 | [Auto-GPT-Plugins](https://github.com/Significant-Gravitas/Auto-GPT-Plugins) | 3563 | 🔠 🔌  | Plugins for Auto-GPT |
| 2023-04-09 | [turbopilot](https://github.com/ravenscroftj/turbopilot) | 3785 | 🔠 🔨 `C++`  | Turbopilot is an open source large-language-model based code completion engine that runs locally on CPU |
...
| 2023-04-08 | [ChatALL](https://github.com/sunner/ChatALL) | 9366 | 🔠 🔨 `JavaScript`  |  Concurrently chat with ChatGPT, Bing Chat, Bard, Alpaca, Vicuna, Claude, ChatGLM, MOSS, 讯飞星火, 文心一言 and more, discover the best answers |
...
| 2023-04-07 | [LangChain-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/LangChain-Chinese-Getting-Started-Guide) | 5238 | 🔠 📝  | LangChain 的中文入门教程 |
| 2023-04-07 | [AgentGPT](https://github.com/reworkd/AgentGPT) | 26111 | 🔠 🔨 `TypeScript`  | 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser. |
...
| 2023-04-06 | [lollms-webui](https://github.com/ParisNeo/lollms-webui) | 2774 | 🔠 🔨 `CSS`  | Lord of Large Language Models Web User Interface |
...
| 2023-04-06 | [plugins-quickstart](https://github.com/openai/plugins-quickstart) | 3729 | 🔠 📝 🔌  | Get a ChatGPT plugin up and running in under 5 minutes! |
| 2023-04-05 | [ai-shell](https://github.com/BuilderIO/ai-shell) | 3227 | 🔠 🔨 `TypeScript`  | A CLI that converts natural language to shell commands. |
| 2023-04-05 | [ChatGPT-to-API](https://github.com/acheong08/ChatGPT-to-API) | 987 | 🔠 🔨 `Go`  | Scalable unofficial ChatGPT API for production. |
| 2023-04-05 | [ix](https://github.com/kreneskyp/ix) | 704 | 🔠 🔨 `Python`  | Autonomous GPT-4 agent platform |
| 2023-04-04 | [cf-openai-azure-proxy](https://github.com/haibbo/cf-openai-azure-proxy) | 1260 | 🔠 🔨 `JavaScript`  | A Cloudflare worker script to proxy OpenAI‘s request to Azure OpenAI Service |
...
| 2023-04-03 | [GPTeam](https://github.com/101dotxyz/GPTeam) | 1280 | 🔠 🔨 `Python`  | GPTeam: An open-source multi-agent simulation |
...
| 2023-04-03 | [cloudflare-proxy](https://github.com/barretlee/cloudflare-proxy) | 746 | 🔠 🔨 `JavaScript`  | Cloudflare Worker 代理请求 ChatGPT API，支持 Stream 流式输出 |
| 2023-04-03 | [babyagi](https://github.com/yoheinakajima/babyagi) | 16871 | 🔠 🔨 `Python`  |  |
| 2023-04-02 | [JittorLLMs](https://github.com/Jittor/JittorLLMs) | 1834 | 🔠 💡  | 计图大模型推理库，具有高性能、配置要求低、中文支持好、可移植等特点 |
| 2023-04-02 | [courses](https://github.com/SkalskiP/courses) | 3641 | 🔠 📝  | This repository is a curated collection of links to various courses and resources about Artificial Intelligence (AI) |
...
| 2023-04-01 | [llm](https://github.com/simonw/llm) | 1018 | 🔠 🔨 `Python`  | Access large language models from the command-line |
...
| 2023-04-01 | [unit-minions](https://github.com/unit-mesh/unit-minions) | 813 | 🔠 📝  | 《AI 研发提效研究：自己动手训练 LoRA》，包含 Llama  （Alpaca LoRA）模型、ChatGLM （ChatGLM Tuning）相关 Lora 的训练。训练内容：用户故事生成、测试代码生成、代码辅助生成、文本转 SQL、文本生成代码…… |
| 2023-03-31 | [Flowise](https://github.com/FlowiseAI/Flowise) | 15074 | 🔠 🔨 `TypeScript`  | Drag & drop UI to build your customized LLM flow |
| 2023-03-31 | [Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) | 16034 | 🔠 📝  | A GPT-4 AI Tutor Prompt for customizable personalized learning experiences. |
| 2023-03-31 | [best-chinese-prompt](https://github.com/K-Render/best-chinese-prompt) | 774 | 🔠 📝  | AI中文提示词秘籍ChatGPT中文提示词秘籍（Prompt圣经）K-Render整理 |
...
| 2023-03-31 | [BMTools](https://github.com/OpenBMB/BMTools) | 2534 | 🔠 🔌  | Tool Learning for Big Models, Open-Source Solutions of ChatGPT-Plugins |
...
| 2023-03-31 | [Langchain-Chatchat](https://github.com/chatchat-space/Langchain-Chatchat) | 15035 | 🔠 🔨 🀄 `Python`  | Langchain-Chatchat（原Langchain-ChatGLM）基于 Langchain 与 ChatGLM 等语言模型的本地知识库问答 \| Langchain-Chatchat (formerly langchain-ChatGLM), local knowledge based LLM (like ChatGLM) QA app with langchain  |
...
| 2023-03-30 | [GPT-Prompts](https://github.com/jesselau76/GPT-Prompts) | 793 | 🔠 📝  | Useful GPT Prompts |
...
| 2023-03-30 | [yakGPT](https://github.com/yakGPT/yakGPT) | 1414 | 🔠 🔨 `TypeScript`  | Locally running, hands-free ChatGPT UI |
...
| 2023-03-29 | [mods](https://github.com/charmbracelet/mods) | 1490 | 🔠 🔨 `Go`  | AI on the command line |
...
| 2023-03-29 | [gpt4free](https://github.com/xtekky/gpt4free) | 44482 | 🔠 🔨 `Python`  | The official gpt4free repository \| various collection of powerful language models |
| 2023-03-29 | [awesome-instruction-dataset](https://github.com/yaodongC/awesome-instruction-dataset) | 757 | 🔠 ⛽  | A collection of open-source dataset to train instruction-following LLMs (ChatGPT,LLaMA,Alpaca) |
| 2023-03-28 | [zotero-gpt](https://github.com/MuiseDestiny/zotero-gpt) | 2406 | 🔠 🔨 `TypeScript`  | GPT Meet Zotero. |
...
| 2023-03-28 | [speechgpt](https://github.com/hahahumble/speechgpt) | 2597 | 🔠 🔨 `TypeScript`  | 💬 SpeechGPT is a web application that enables you to converse with ChatGPT. |
| 2023-03-28 | [flux](https://github.com/paradigmxyz/flux) | 598 | 🔠 🔨 `TypeScript`  | Graph-based LLM power tool for exploring many completions in parallel. |
| 2023-03-28 | [KeepChatGPT](https://github.com/xcanwin/KeepChatGPT) | 11239 | 🔠 🔨 `JavaScript`  | 这是一款提高ChatGPT的数据安全能力和效率的插件。并且免费共享大量创新功能，如：自动刷新、保持活跃、数据安全、取消审计、克隆对话、言无不尽、净化首页、展示大屏、展示全屏、拦截跟踪、日新月异等。让我们的AI体验无比安全、顺畅、丝滑、高效、简洁。 |
...
| 2023-03-27 | [databerry](https://github.com/gmpetrov/databerry) | 2484 | 🔠 🔨 `TypeScript`  | The no-code platform for building custom LLM Agents |
| 2023-03-27 | [chatgpt-tool-hub](https://github.com/goldfishh/chatgpt-tool-hub) | 721 | 🔠 🔨 `Python`  | An open-source chatgpt tool ecosystem where you can combine tools with chatgpt and use natural language to do anything. |
| 2023-03-27 | [gpt4all](https://github.com/nomic-ai/gpt4all) | 51602 | 🔠 🔨 `C++`  | gpt4all: an ecosystem of open-source chatbots trained on a massive collections of clean assistant data including code, stories and dialogue |
| 2023-03-26 | [LlamaChat](https://github.com/alexrozanski/LlamaChat) | 1209 | 🔠 🔨 `Swift`  | Chat with your favourite LLaMA models in a native macOS app |
| 2023-03-26 | [ChainForge](https://github.com/ianarawjo/ChainForge) | 1066 | 🔠 🔨 `TypeScript`  | An open-source visual programming environment for LLM experimentation and prompt evaluation. |
| 2023-03-26 | [cheetah](https://github.com/leetcode-mafia/cheetah) | 3328 | 🔠 🔨 `Swift`  | Mac app for crushing remote tech interviews with AI |
...
| 2023-03-25 | [wenda](https://github.com/wenda-LLM/wenda) | 5324 | 🔠 🔨 `JavaScript`  | 闻达：一个LLM调用平台。目标为针对特定环境的高效内容生成，同时考虑个人和中小企业的计算资源局限性，以及知识安全和私密性问题 |
...
| 2023-03-24 | [promptr](https://github.com/ferrislucas/promptr) | 731 | 🔠 🔨 `JavaScript`  | Promptr is a CLI tool that lets you use plain English to instruct GPT3 or GPT4 to make changes to your codebase.  |
...
| 2023-03-24 | [yu-auto-reply](https://github.com/liyupi/yu-auto-reply) | 769 | 🔠 🔨 `Java`  | AI 自动回复工具，支持灵活配置多个平台的监控和回答。目前已支持知识星球自动回复、OpenAI（ChatGPT）自动回答 |
| 2023-03-24 | [azure-openai-proxy](https://github.com/stulzq/azure-openai-proxy) | 869 | 🔠 🔨 `Go`  | Azure OpenAI Service Proxy. Convert OpenAI official API request to Azure OpenAI API request. Support GPT-4,Embeddings. |
| 2023-03-24 | [GPTCache](https://github.com/zilliztech/GPTCache) | 5094 | 🔠 🔨 `Python`  | Semantic cache for LLMs. Fully integrated with LangChain and llama_index.  |
...
| 2023-03-23 | [llama-cpp-python](https://github.com/abetlen/llama-cpp-python) | 2998 | 🔠 💡  | Python bindings for llama.cpp |
| 2023-03-23 | [chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) | 19377 | 🔠 🔨 `Python`  | The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language. |
...
| 2023-03-22 | [subvert](https://github.com/aschmelyun/subvert) | 605 | 🔠 🎥 🔨 `PHP`  | Generate subtitles, summaries, and chapters from videos in seconds |
...
| 2023-03-22 | [ai-beehive](https://github.com/hncboy/ai-beehive) | 1670 | 🔠 🔨 `Java`  | AI 蜂巢，基于 Java 使用 Spring Boot 3 和 JDK 17，支持的功能有 ChatGPT、OpenAi Image、Midjourney、NewBing、文心一言等等 |
| 2023-03-22 | [simple-llm-finetuner](https://github.com/lxe/simple-llm-finetuner) | 1853 | 🔠 🔨 `Jupyter`  | Simple UI for LLM Model Finetuning |
| 2023-03-22 | [reflexion](https://github.com/noahshinn024/reflexion) | 1368 | 🔠 🔨 `Python`  | Reflexion: Language Agents with Verbal Reinforcement Learning |
...
| 2023-03-22 | [openprompt.co](https://github.com/timqian/openprompt.co) | 1022 | 🔠 📝  | Create. Use. Share. ChatGPT prompts |
...
| 2023-03-21 | [CodeCursor](https://github.com/Helixform/CodeCursor) | 1260 | 🔠 🔨 `TypeScript`  | An extension for using Cursor in Visual Studio Code.  |
...
| 2023-03-21 | [BlenderGPT](https://github.com/gd3kr/BlenderGPT) | 3833 | 🔠 🔨 `Python`  | Use commands in English to control Blender with OpenAI's GPT-4 |
| 2023-03-21 | [AlpacaDataCleaned](https://github.com/gururise/AlpacaDataCleaned) | 1227 | 🔠 ⛽  | Alpaca dataset from Stanford, cleaned and curated |
| 2023-03-21 | [langchain-ui](https://github.com/homanp/langchain-ui) | 794 | 🔠 🔨 `JavaScript`  | 🧬 The open source chat-ai toolkit |
| 2023-03-21 | [langchain-serve](https://github.com/jina-ai/langchain-serve) | 1414 | 🔠 🔨 `Python`  | ⚡ Langchain Apps on Production with Jina & FastAPI 🚀 |
| 2023-03-21 | [k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) | 3154 | 🔠 🔨 `Go`  | Giving Kubernetes Superpowers to everyone |
...
| 2023-03-21 | [FreedomGPT](https://github.com/ohmplatform/FreedomGPT) | 2181 | 🔠 🔨 `TypeScript`  | This codebase is for a React and Electron-based app that executes the FreedomGPT LLM locally (offline and private) on Mac and Windows using a chat-based interface (based on Alpaca Lora) |
| 2023-03-21 | [novel](https://github.com/steven-tey/novel) | 7055 | 🔠 🔨 `TypeScript`  | Notion-style WYSIWYG editor with AI-powered autocompletion. |
| 2023-03-21 | [awesome-chatgpt-zh](https://github.com/yzfly/awesome-chatgpt-zh) | 8060 | 🔠 📝 🀄  | ChatGPT 中文指南🔥，ChatGPT 中文调教指南，指令指南，应用开发指南，精选资源清单，更好的使用 chatGPT 让你的生产力 up up up! 🚀 |
...
| 2023-03-20 | [The-Art-of-Asking-ChatGPT-for-High-Quality-Answers-A-complete-Guide-to-Prompt-Engineering-Technique](https://github.com/ORDINAND/The-Art-of-Asking-ChatGPT-for-High-Quality-Answers-A-complete-Guide-to-Prompt-Engineering-Technique) | 838 | 🔠 📝  | ChatGPT提问技巧 |
...
| 2023-03-20 | [gpt_academic](https://github.com/binary-husky/gpt_academic) | 40446 | 🔠 🔨 `Python`  | 为ChatGPT/GLM提供图形交互界面，特别优化论文阅读/润色/写作体验，模块化设计，支持自定义快捷按钮&函数插件，支持Python和C++等项目剖析&自译解功能，PDF/LaTex论文翻译&总结功能，支持并行问询多种LLM模型，支持chatglm2等本地模型。兼容文心一言, moss, llama2, rwkv, claude2, 通义千问, 书生, 讯飞星火等。 |
...
| 2023-03-19 | [text-to-video-synthesis-colab](https://github.com/camenduru/text-to-video-synthesis-colab) | 1185 | 🔠 🎥 🔨 `Jupyter`  | Text To Video Synthesis Colab |
| 2023-03-19 | [engshell](https://github.com/emcf/engshell) | 2154 | 🔠 🔨 `Python`  | An English-language shell for any OS, powered by LLMs |
| 2023-03-19 | [big-agi](https://github.com/enricoros/big-agi) | 1542 | 🔠 🔨 `TypeScript`  | 💬 Personal AI application powered by GPT-4 and beyond, with AI personas, AGI functions, text-to-image, voice, response streaming, code highlighting and execution, PDF import, presets for developers, much more. Deploy and gift #big-AGI-energy! Using Next.js, React, Joy. |
...
| 2023-03-19 | [chatblade](https://github.com/npiv/chatblade) | 2338 | 🔠 🔨 `Python`  | A CLI Swiss Army Knife for ChatGPT |
| 2023-03-19 | [serge](https://github.com/serge-chat/serge) | 4870 | 🔠 🔨 `Python`  | A web interface for chatting with Alpaca through llama.cpp. Fully dockerized, with an easy to use API. |
...
| 2023-03-18 | [AutoPR](https://github.com/irgolic/AutoPR) | 1085 | 🔠 🔨 `Python`  | Fix issues with AI-generated pull requests, powered by ChatGPT |
| 2023-03-18 | [AICommand](https://github.com/keijiro/AICommand) | 3714 | 🔠 🔨 `C#`  | ChatGPT integration with Unity Editor |
| 2023-03-18 | [awesome-totally-open-chatgpt](https://github.com/nichtdax/awesome-totally-open-chatgpt) | 4106 | 🔠 📝  | A list of totally open alternatives to ChatGPT |
| 2023-03-18 | [ChatReviewer](https://github.com/nishiwen1214/ChatReviewer) | 938 | 🔠 🔨 `Python`  | ChatReviewer: 使用ChatGPT分析论文优缺点，提出改进建议 |
...
| 2023-03-17 | [camel](https://github.com/camel-ai/camel) | 2875 | 🔠 🔨 `Python`  | 🐫 CAMEL: Communicative Agents for “Mind” Exploration of Large Scale Language Model Society |
...
| 2023-03-17 | [chatpad](https://github.com/deiucanta/chatpad) | 899 | 🔠 🔨 `TypeScript`  | Not just another ChatGPT user-interface! |
| 2023-03-17 | [alpaca_chinese_dataset](https://github.com/hikariming/alpaca_chinese_dataset) | 938 | 🔠 ⛽ 2️⃣ 🀄  | 人工精调的中文对话数据集和一段chatglm的微调代码 |
| 2023-03-17 | [gpt4-pdf-chatbot-langchain](https://github.com/mayooear/gpt4-pdf-chatbot-langchain) | 12971 | 🔠 🔨 `TypeScript`  | GPT4 & LangChain Chatbot for large PDF docs |
...
| 2023-03-16 | [tabby](https://github.com/TabbyML/tabby) | 9462 | 🔠 🔨 `TypeScript`  | Self-hosted AI coding assistant |
...
| 2023-03-16 | [New-Bing-Anywhere](https://github.com/ha0z1/New-Bing-Anywhere) | 1258 | 🔠 🔨 `TypeScript`  | 💬 New-Bing-Anywhere extension's source  |
| 2023-03-16 | [The-HustleGPT-Challenge](https://github.com/jtmuller5/The-HustleGPT-Challenge) | 2036 | 🔠 📝  | Building Startups with an AI Co-Founder |
...
| 2023-03-16 | [gpt-repository-loader](https://github.com/mpoon/gpt-repository-loader) | 2091 | 🔠 🔨 `Python`  | Convert code repos into an LLM prompt-friendly format. Mostly built by GPT-4. |
| 2023-03-16 | [ChatGLM-Tuning](https://github.com/mymusise/ChatGLM-Tuning) | 3281 | 🔠 2️⃣ 🀄  | 一种平价的chatgpt实现方案,  基于ChatGLM-6B + LoRA |
| 2023-03-16 | [sqlchat](https://github.com/sqlchat/sqlchat) | 3020 | 🔠 🔨 `TypeScript`  | Chat-based SQL Client and Editor for the next decade |
| 2023-03-15 | [chatGPTBox](https://github.com/josStorer/chatGPTBox) | 8662 | 🔠 🔨 `JavaScript`  | Integrating ChatGPT into your browser deeply, everything you need is here |
| 2023-03-15 | [minillm](https://github.com/kuleshov/minillm) | 619 | 🔠 💡  | MiniLLM is a minimal system for running modern LLMs on consumer-grade GPUs |
| 2023-03-15 | [polyglot](https://github.com/liou666/polyglot) | 2291 | 🔠 🔨 `TypeScript`  | 🤖️ 跨平台AI语言练习应用 |
...
| 2023-03-14 | [ChatGLM-webui](https://github.com/Akegarasu/ChatGLM-webui) | 1763 | 🔠 🔨 `Python`  | A WebUI for ChatGLM-6B |
| 2023-03-14 | [chainlit](https://github.com/Chainlit/chainlit) | 3018 | 🔠 🔨 `TypeScript`  | Build Python LLM apps in minutes ⚡️ |
| 2023-03-14 | [LLMSurvey](https://github.com/RUCAIBox/LLMSurvey) | 5311 | 🔠 📝  | The official GitHub page for the survey paper "A Survey of Large Language Models". |
| 2023-03-14 | [ChatChat](https://github.com/okisdev/ChatChat) | 1000 | 🔠 🔨 `TypeScript`  | Chat Chat, unlock your next level AI conversation experience. Deploy your own AI Interface, all AI in one place. |
...
| 2023-03-13 | [llm](https://github.com/rustformers/llm) | 4732 | 🔠 💡  | An ecosystem of Rust libraries for working with large language models |
...
| 2023-03-12 | [cursor](https://github.com/getcursor/cursor) | 17373 | 🔠 ❓  | An editor made for programming with AI 🤖 |
| 2023-03-11 | [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) | 17263 | 🔠 🔨 `TypeScript`  | An open source ChatGPT UI. |
...
| 2023-03-10 | [chain-of-thought-hub](https://github.com/FranxYao/chain-of-thought-hub) | 1865 | 🔠 📝  | Benchmarking large language models' complex reasoning ability with chain-of-thought prompting |
...
| 2023-03-10 | [marvin](https://github.com/PrefectHQ/marvin) | 3244 | 🔠 🔨 `Python`  | ✨ Build AI interfaces that spark joy |
| 2023-03-10 | [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) | 42206 | 🔠 🔨 `TypeScript`  | A well-designed cross-platform ChatGPT UI (Web / PWA / Linux / Win / MacOS). 一键拥有你自己的跨平台 ChatGPT 应用。 |
| 2023-03-10 | [ChatGPTProxy](https://github.com/acheong08/ChatGPTProxy) | 1248 | 🔠 🔨 `Go`  | Simple Cloudflare bypass for ChatGPT |
| 2023-03-10 | [poe-api](https://github.com/ading2210/poe-api) | 2456 | 🔠 🔨 `Python`  | [MAINTAINERS NEEDED] A reverse engineered Python API wrapper for Quora's Poe, which provides free access to ChatGPT, GPT-4, and Claude. |
...
| 2023-03-08 | [chatgpt-i18n](https://github.com/ObservedObserver/chatgpt-i18n) | 679 | 🔠 🔨 `TypeScript`  | Localize your websites with AI assistance. |
...
| 2023-03-08 | [ChatPaper](https://github.com/kaixindelele/ChatPaper) | 14616 | 🔠 🔨 `Python`  | Use ChatGPT to summarize the arXiv papers. 全流程加速科研，利用chatgpt进行论文全文总结+专业翻译+润色+审稿+审稿回复 |
| 2023-03-08 | [myGPTReader](https://github.com/madawei2699/myGPTReader) | 4183 | 🔠 🔨 `Python`  | A community-driven way to read and chat with AI bots - powered by chatGPT. |
| 2023-03-07 | [pdfGPT](https://github.com/bhaskatripathi/pdfGPT) | 5806 | 🔠 🔨 `Python`  | PDF GPT allows you to chat with the contents of your PDF file by using GPT capabilities. The most effective open source solution to turn your pdf files in a chatbot! |
| 2023-03-07 | [openai-gpt-dev-notes-for-cn-developer](https://github.com/easychen/openai-gpt-dev-notes-for-cn-developer) | 1291 | 🔠 📝  | 如何快速开发一个OpenAI/GPT应用：国内开发者笔记 |
| 2023-03-07 | [subtitle-translator-electron](https://github.com/gnehs/subtitle-translator-electron) | 1247 | 🔠 🔨  | ↔️ Translate subtitle using ChatGPT |
| 2023-03-06 | [chatbox](https://github.com/Bin-Huang/chatbox) | 14457 | 🔠 🔨 `TypeScript`  | Chatbox is a desktop app for multiple cutting-edge LLM models that available on Windows, Mac, Linux |
| 2023-03-06 | [openai-scf-proxy](https://github.com/Ice-Hazymoon/openai-scf-proxy) | 2242 | 🔠 🔨 `JavaScript`  | 使用腾讯云函数一分钟搭建 OpenAI 免翻墙代理 |
| 2023-03-06 | [chatarena](https://github.com/chatarena/chatarena) | 968 | 🔠 🔨 `Python`  | ChatArena (or Chat Arena) is a Multi-Agent Language Game Environments for LLMs. The goal is to develop communication and collaboration capabilities of AIs. |
...
| 2023-03-06 | [opencommit](https://github.com/di-sukharev/opencommit) | 4408 | 🔠 🔨 `JavaScript`  | Auto-generate impressive commits with AI in 1 second 🤯🔫 |
| 2023-03-06 | [GPTQ-for-LLaMa](https://github.com/qwopqwop200/GPTQ-for-LLaMa) | 2560 | 🔠 ✂️  | 4 bits quantization of LLaMA using GPTQ |
| 2023-03-06 | [Learning-Prompt](https://github.com/thinkingjimmy/Learning-Prompt) | 4704 | 🔠 📝  | Free prompt engineering online course. ChatGPT and Midjourney tutorials are now included! |
| 2023-03-05 | [gerev](https://github.com/GerevAI/gerev) | 2463 | 🔠 🔨 `Python`  | 🧠 AI-powered enterprise search engine 🔎 |
| 2023-03-05 | [AIShader](https://github.com/keijiro/AIShader) | 2014 | 🔠 🔨 `C#`  | ChatGPT-powered shader generator for Unity |
| 2023-03-05 | [llama-dl](https://github.com/shawwn/llama-dl) | 4040 | 🔠 ❓  | High-speed download of LLaMA, Facebook's 65B parameter GPT model |
| 2023-03-04 | [CodeGPT](https://github.com/appleboy/CodeGPT) | 724 | 🔠 🔨 `Go`  | A CLI written in Go language that writes git commit messages or do a code review brief for you using ChatGPT AI (gpt-4, gpt-3.5-turbo model) and automatically installs a git prepare-commit-msg hook. |
...
| 2023-03-04 | [chathub](https://github.com/chathub-dev/chathub) | 8020 | 🔠 🔨 `TypeScript`  | All-in-one chatbot client |
| 2023-03-04 | [e2b](https://github.com/e2b-dev/e2b) | 5394 | 🔠 🔨 `TypeScript`  | Monorepo for E2B - Cloud Operating System for AI Agents |
| 2023-03-04 | [openai-translator](https://github.com/openai-translator/openai-translator) | 17759 | 🔠 🔨 `TypeScript`  | 基于 ChatGPT API 的划词翻译浏览器插件和跨平台桌面端应用    -    Browser extension and cross-platform desktop application for translation based on ChatGPT API. |
| 2023-03-04 | [chatgpt-vercel](https://github.com/ourongxing/chatgpt-vercel) | 2950 | 🔠 🔨 `TypeScript`  | Elegant and Powerfull. Powered by OpenAI and Vercel. |
...
| 2023-03-04 | [ai-component-generator](https://github.com/yuvalsuede/ai-component-generator) | 1256 | 🔠 🔨 `TypeScript`  | This project generates almost any UI components with OpenAI's ChatGPT and allows you to copy the html code |
| 2023-03-03 | [ChatGPT-Telegram-Workers](https://github.com/TBXark/ChatGPT-Telegram-Workers) | 2861 | 🔠 🔨 `JavaScript`  | Deploy your own Telegram ChatGPT bot on Cloudflare Workers with ease. |
...
| 2023-03-03 | [openai-api-proxy](https://github.com/easychen/openai-api-proxy) | 1256 | 🔠 🔨 `JavaScript`  | 一行Docker命令部署的 OpenAI/GPT API代理，支持SSE流式返回、腾讯云函数 。Simple proxy for OpenAi api via a one-line docker command |
| 2023-03-03 | [OpenGpt](https://github.com/futantan/OpenGpt) | 3623 | 🔠 🔨 `TypeScript`  | Create your own ChatGPT App in seconds. |
| 2023-03-03 | [chatgpt-web-share](https://github.com/moeakwak/chatgpt-web-share) | 2395 | 🔠 🔨 `Vue`  | A fully-featured multi-user ChatGPT Web system, with Plus account or API as providers. |
...
| 2023-03-03 | [aichat](https://github.com/sigoden/aichat) | 1470 | 🔠 🔨 `Rust`  | Using ChatGPT/GPT-3.5/GPT-4 in the terminal. |
| 2023-03-03 | [OpenChatKit](https://github.com/togethercomputer/OpenChatKit) | 8864 | 🔠 ⛽ 🚌 1️⃣ 2️⃣  |  |
| 2023-03-03 | [BetterChatGPT](https://github.com/ztjhz/BetterChatGPT) | 5796 | 🔠 🔨 `TypeScript`  | An amazing UI for OpenAI's ChatGPT (Website + Windows + MacOS + Linux) |
| 2023-03-02 | [ChuanhuChatGPT](https://github.com/GaiZhenbiao/ChuanhuChatGPT) | 12154 | 🔠 🔨 `Python`  | GUI for ChatGPT API and many LLMs |
| 2023-03-02 | [chatgpt-web](https://github.com/Niek/chatgpt-web) | 774 | 🔠 🔨 `Svelte`  | ChatGPT web interface using the OpenAI API |
...
| 2023-03-02 | [bilingual_book_maker](https://github.com/yihong0618/bilingual_book_maker) | 6140 | 🔠 🔨 `Python`  | Make bilingual epub books Using AI translate |
...
| 2023-02-28 | [chatgpt-pgvector](https://github.com/gannonh/chatgpt-pgvector) | 889 | 🔠 🔨 `TypeScript`  | ChatGTP (gpt3.5-turbo) starter app |
| 2023-02-28 | [pyllama](https://github.com/juncongmoo/pyllama) | 2591 | 🔠 ✂️  | LLaMA: Open and Efficient Foundation Language Models |
| 2023-02-27 | [PentestGPT](https://github.com/GreyDGL/PentestGPT) | 4938 | 🔠 🔨 `Python`  | A GPT-empowered penetration testing tool |
| 2023-02-27 | [LLM-As-Chatbot](https://github.com/deep-diver/LLM-As-Chatbot) | 2999 | 🔠 🔨 `Python`  | LLM as a Chatbot Service |
| 2023-02-27 | [chatllama](https://github.com/juncongmoo/chatllama) | 1128 | 🔠 3️⃣  | ChatLLaMA 📢 Open source implementation for LLaMA-based ChatGPT runnable in a single GPU. 15x faster training process than ChatGPT |
| 2023-02-27 | [semantic-kernel](https://github.com/microsoft/semantic-kernel) | 12254 | 🔠 🔨 `C#`  | Integrate cutting-edge LLM technology quickly and easily into your apps |
| 2023-02-27 | [PandoraAI](https://github.com/waylaidwanderer/PandoraAI) | 731 | 🔠 🔨 `Vue`  | PandoraAI is a web chat client powered by node-chatgpt-api, allowing users to easily chat with multiple AI systems while also offering support for custom presets. With its seamless and convenient design, PandoraAI provides an engaging conversational AI experience. |
...
| 2023-02-26 | [go-chatgpt-api](https://github.com/linweiyuan/go-chatgpt-api) | 1153 | 🔠 🔨 `Go`  | 一个尝试绕过 Cloudflare 来使用 ChatGPT 接口的程序 |
| 2023-02-26 | [AI0x0.com](https://github.com/mushan0x0/AI0x0.com) | 2774 | 🔠 🔨  | 一个多模态多模型通用型的全能 AI 查询生成桌面悬浮助手应用 |
| 2023-02-26 | [openplayground](https://github.com/nat/openplayground) | 5351 | 🔠 🔨 `TypeScript`  | An LLM playground you can run on your laptop |
| 2023-02-24 | [ChatGPT-Shortcut](https://github.com/rockbenben/ChatGPT-Shortcut) | 5133 | 🔠 📝  | 🚀💪Maximize your efficiency and productivity, support for English,中文,Español,العربية. 让生产力加倍的ChatGPT快捷指令，无需熟悉提示词，就能轻松搜索、优化和管理Prompts，适应多语言及各种生产效率场景。 |
...
| 2023-02-19 | [llm-security](https://github.com/greshake/llm-security) | 1335 | 🔠 📝  | New ways of breaking app-integrated LLMs  |
...
| 2023-02-17 | [chat-ui](https://github.com/huggingface/chat-ui) | 3409 | 🔠 🔨 `TypeScript`  | Open source codebase powering the HuggingChat app |
| 2023-02-16 | [BingGPT](https://github.com/dice2o/BingGPT) | 8939 | 🔠 🔨 `JavaScript`  | Desktop application of new Bing's AI-powered chat (Windows, macOS and Linux) |
| 2023-02-16 | [chatgpt](https://github.com/dirk1983/chatgpt) | 2362 | 🔠 🔨 `JavaScript`  | 全网最易部署，响应速度最快的ChatGPT环境。PHP版调用OpenAI接口进行问答和画图，采用Stream流模式通信，一边生成一边输出。前端采用EventSource，支持Markdown格式解析，支持公式显示，代码有着色处理，支持画图。页面UI简洁，支持上下文连续会话。源码只有几个文件，没用任何框架，支持所有PHP版本，全部开源，极易二开。保姆级教程，全部周边资源，欢迎进群交流，一切全免费。 |
| 2023-02-16 | [unlocking-the-power-of-llms](https://github.com/howl-anderson/unlocking-the-power-of-llms) | 2439 | 🔠 📝  | 使用 Prompts 和 Chains 让 ChatGPT 成为神奇的生产力工具！Unlocking the power of LLMs. |
| 2023-02-16 | [xiaogpt](https://github.com/yihong0618/xiaogpt) | 3768 | 🔠 🔨 `Python`  | Play ChatGPT and other LLM with Xiaomi AI Speaker |
| 2023-02-15 | [ChatGPT_DAN](https://github.com/0xk1h0/ChatGPT_DAN) | 3897 | 🔠 📝  | ChatGPT DAN, Jailbreaks prompt |
...
| 2023-02-14 | [aicommits](https://github.com/Nutlope/aicommits) | 6215 | 🔠 🔨 `TypeScript`  | A CLI that writes your git commit messages for you with AI |
| 2023-02-14 | [llama](https://github.com/facebookresearch/llama) | 40652 | 🔠 🚌  | Inference code for LLaMA models |
| 2023-02-13 | [langchain-tutorials](https://github.com/gkamradt/langchain-tutorials) | 4864 | 🔠 📝  | Overview and tutorial of the LangChain Library |
| 2023-02-13 | [transformers.js](https://github.com/xenova/transformers.js) | 3434 | 🔠 ❓  | State-of-the-art Machine Learning for the web. Run 🤗 Transformers directly in your browser, with no need for a server! |
| 2023-02-11 | [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) | 8182 | 🔠 ⛽ 🚕 🀄  | Data-Centric FinGPT.  Open-source for open finance!  Revolutionize 🔥    We release the trained model on HuggingFace. |
| 2023-02-11 | [chatgpt-java](https://github.com/Grt1228/chatgpt-java) | 2354 | 🔠 🔨 `Java`  | ChatGPT Java SDK支持流式输出、Gpt插件、联网。支持OpenAI官方所有接口。ChatGPT的Java客户端。OpenAI GPT-3.5-Turb GPT-4  Api Client for Java |
| 2023-02-11 | [ChatGPT-CodeReview](https://github.com/anc95/ChatGPT-CodeReview) | 2903 | 🔠 🔨 `JavaScript`  | 🐥 A code review bot powered by ChatGPT |
| 2023-02-10 | [chatgpt-web](https://github.com/869413421/chatgpt-web) | 3110 | 🔠 🔨 `Go`  | 基于ChatGPT3.5 API实现的私有化web程序 |
| 2023-02-09 | [chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web) | 26528 | 🔠 🔨 `Vue`  | 用 Express 和  Vue3 搭建的 ChatGPT 演示网页 |
| 2023-02-09 | [SillyTavern](https://github.com/SillyTavern/SillyTavern) | 2104 | 🔠 🔨 `JavaScript`  | LLM Frontend for Power Users. |
| 2023-02-09 | [EdgeGPT](https://github.com/acheong08/EdgeGPT) | 7870 | 🔠 🔨 `Python`  | Reverse engineered API of Microsoft's Bing Chat AI |
| 2023-02-09 | [weekly_report](https://github.com/guaguaguaxia/weekly_report) | 3025 | 🔠 🔨 `CSS`  | 简单描述工作内容，帮你生成完整周报 |
| 2023-02-09 | [Awesome-Prompt-Engineering](https://github.com/promptslab/Awesome-Prompt-Engineering) | 2059 | 🔠 📝  | This repository contains a hand-curated resources for Prompt Engineering with a focus on Generative Pre-trained Transformer (GPT), ChatGPT, PaLM etc  |
| 2023-02-09 | [vllm](https://github.com/vllm-project/vllm) | 6016 | 🔠 💡  | A high-throughput and memory-efficient inference and serving engine for LLMs |
| 2023-02-09 | [bot-on-anything](https://github.com/zhayujie/bot-on-anything) | 3134 | 🔠 🔨 `Python`  | Connect AI models (like ChatGPT-3.5/4.0, Baidu Yiyan, New Bing, Bard) to apps (like Wechat, public account, DingTalk, Telegram,  QQ).  将 ChatGPT、必应、文心一言、谷歌Bard 等对话模型连接各类应用，如微信、公众号、QQ、Telegram、Gmail、Slack、Web、企业微信、飞书、钉钉等。 |
| 2023-02-08 | [azure-search-openai-demo](https://github.com/Azure-Samples/azure-search-openai-demo) | 3473 | 🔠 🔨 `Python`  | A sample app for the Retrieval-Augmented Generation pattern running in Azure, using Azure Cognitive Search for retrieval and Azure OpenAI large language models  to power ChatGPT-style and Q&A experiences. |
| 2023-02-08 | [langflow](https://github.com/logspace-ai/langflow) | 11933 | 🔠 🔨 `Python`  | ⛓️ Langflow is a UI for LangChain, designed with react-flow to provide an effortless way to experiment and prototype flows. |
| 2023-02-07 | [Feishu-OpenAI](https://github.com/ConnectAI-E/Feishu-OpenAI) | 4815 | 🔠 🔨 `Go`  | 🎒 飞书  ×（GPT-4 + DALL·E + Whisper）=  飞一般的工作体验  🚀 语音对话、角色扮演、多话题讨论、图片创作、表格分析、文档导出 🚀 |
| 2023-02-06 | [langchainjs](https://github.com/hwchase17/langchainjs) | 7974 | 🔠 🔨 `TypeScript`  | This is built to integrate as seamlessly as possible with the LangChain Python package. |
| 2023-02-05 | [paper-qa](https://github.com/whitead/paper-qa) | 2984 | 🔠 🔨 `Python`  | LLM Chain for answering questions from documents with citations |
| 2023-02-02 | [DocsGPT](https://github.com/arc53/DocsGPT) | 6395 | 🔠 🔨 `Python`  | GPT-powered chat for documentation, chat with your documents |
| 2023-02-01 | [llama-hub](https://github.com/emptycrown/llama-hub) | 2274 | 🔠 🔨 `Jupyter`  | A library of data loaders for LLMs made by the community -- to be used with GPT Index and/or LangChain |
| 2023-02-01 | [researchgpt](https://github.com/mukulpatnaik/researchgpt) | 3332 | 🔠 🔨 `Python`  | A LLM based research assistant that allows you to have a conversation with a research paper |
| 2023-01-31 | [GraphGPT](https://github.com/varunshenoy/GraphGPT) | 3773 | 🔠 🔨 `JavaScript`  | Extrapolating knowledge graphs from unstructured text using GPT-3 🕵️‍♂️ |
| 2023-01-29 | [guardrails](https://github.com/ShreyaR/guardrails) | 2116 | 🔠 🔨 `Python`  | Adding guardrails to large language models. |
| 2023-01-23 | [evals](https://github.com/openai/evals) | 11651 | 🔠 ⛽  | Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks. |
| 2023-01-21 | [backend-GPT](https://github.com/RootbeerComputer/backend-GPT) | 2891 | 🔠 🔨 `JavaScript`  |  |
| 2023-01-18 | [shell_gpt](https://github.com/TheR1D/shell_gpt) | 5937 | 🔠 🔨 `Python`  | A command-line productivity tool powered by GPT-3 and GPT-4, will help you accomplish your tasks faster and more efficiently. |
| 2023-01-16 | [chat-langchain](https://github.com/langchain-ai/chat-langchain) | 3360 | 🔠 🔨 `Python`  | This repository provides a Windows-focused Gradio GUI for Kohya's Stable Diffusion trainers. The GUI allows you to set the training parameters and generate and run the required CLI commands to train the model. |
...
| 2023-01-13 | [gptcommit](https://github.com/zurawiki/gptcommit) | 2151 | 🔠 🔨 `Rust`  | A git prepare-commit-msg hook for authoring commit messages with GPT-3. |
...
| 2023-01-07 | [node-chatgpt-api](https://github.com/waylaidwanderer/node-chatgpt-api) | 3922 | 🔠 🔨 `JavaScript`  | A client implementation for ChatGPT and Bing AI. Available as a Node.js module, REST API server, and CLI app. |
...
| 2022-12-21 | [text-generation-webui](https://github.com/oobabooga/text-generation-webui) | 22699 | 🔠 🔨 `Python`  | A Gradio web UI for Large Language Models. Supports transformers, GPTQ, llama.cpp (ggml/gguf), Llama models. |
| 2022-12-20 | [self-instruct](https://github.com/yizhongw/self-instruct) | 3005 | 🔠 ⛽  | Aligning pretrained language models with instruction data generated by themselves. |
| 2022-12-16 | [Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) | 35262 | 🔠 📝  | 🐙 Guides, papers, lecture, notebooks and resources for prompt engineering |
| 2022-12-13 | [Open-Assistant](https://github.com/LAION-AI/Open-Assistant) | 35011 | 🔠 🔨 `Python`  | OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and retrieve information dynamically to do so. |
| 2022-12-12 | [awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) | 43252 | 🔠 📝  | ChatGPT 中文调教指南。各种场景使用指南。学习怎么让它听你的话。 |
| 2022-12-12 | [Promptify](https://github.com/promptslab/Promptify) | 2487 | 🔠 🔨 `Jupyter`  | Prompt Engineering \| Prompt Versioning \| Use GPT or other prompt based models to get structured output. Join our discord for Prompt-Engineering, LLMs and other latest research |
| 2022-12-11 | [Awesome-ChatGPT-prompts-ZH_CN](https://github.com/L1Xu4n/Awesome-ChatGPT-prompts-ZH_CN) | 2092 | 🔠 🔨  | 如何将ChatGPT调教成一只猫娘 |
| 2022-12-10 | [bloop](https://github.com/BloopAI/bloop) | 7737 | 🔠 🔨 `Rust`  | bloop is a fast code search engine written in Rust. |
| 2022-12-10 | [ChatGPT.nvim](https://github.com/jackMort/ChatGPT.nvim) | 2480 | 🔠 🔨 `Lua`  | ChatGPT Neovim Plugin: Effortless Natural Language Generation with OpenAI's ChatGPT API |
| 2022-12-09 | [PaLM-rlhf-pytorch](https://github.com/lucidrains/PaLM-rlhf-pytorch) | 7253 | 🔠 3️⃣  | Implementation of RLHF (Reinforcement Learning with Human Feedback) on top of the PaLM architecture. Basically ChatGPT but with PaLM |
| 2022-12-09 | [gpt-ai-assistant](https://github.com/memochou1993/gpt-ai-assistant) | 6130 | 🔠 🔨 `JavaScript`  | OpenAI + LINE + Vercel = GPT AI Assistant |
| 2022-12-09 | [chatgpt-android](https://github.com/skydoves/chatgpt-android) | 3221 | 🔠 🔨 `Kotlin`  | 📲 ChatGPT Android demonstrates OpenAI's ChatGPT on Android with Stream Chat SDK for Compose. |
| 2022-12-08 | [whatsapp-chatgpt](https://github.com/askrella/whatsapp-chatgpt) | 2864 | 🔠 🔨 `TypeScript`  | ChatGPT + DALL-E + WhatsApp = AI Assistant :rocket: :robot: |
| 2022-12-07 | [chatgpt-java](https://github.com/PlexPt/chatgpt-java) | 2922 | 🔠 🔨 `Java`  | ChatGPT Java SDK。支持 GPT3.5、 GPT4 API。开箱即用。 |
| 2022-12-07 | [QChatGPT](https://github.com/RockChinQ/QChatGPT) | 2844 | 🔠 🔨 `Python`  | 😎高稳定性、🧩支持插件、🌏实时联网的 ChatGPT QQ 机器人🤖 \| 支持 Claude、Google Bard、gpt4free 的 QQ 机器人平台 |
| 2022-12-07 | [aiac](https://github.com/gofireflyio/aiac) | 2828 | 🔠 🔨 `Go`  | Artificial Intelligence Infrastructure-as-Code Generator. |
| 2022-12-07 | [ChatGPT](https://github.com/lencx/ChatGPT) | 40684 | 🔠 🔨 `Rust`  | 🔮 ChatGPT Desktop Application (Mac, Windows and Linux) |
...
| 2022-12-06 | [vscode-chatgpt](https://github.com/gencay/vscode-chatgpt) | 3364 | 🔠 🔨 `TypeScript`  | An unofficial Visual Studio Code - OpenAI ChatGPT integration |
| 2022-12-05 | [ChatGPT-wechat-bot](https://github.com/AutumnWhj/ChatGPT-wechat-bot) | 4222 | 🔠 🔨 `TypeScript`  | ChatGPT for wechat https://github.com/AutumnWhj/ChatGPT-wechat-bot |
| 2022-12-05 | [awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) | 87728 | 🔠 📝  | This repo includes ChatGPT prompt curation to use ChatGPT better. |
| 2022-12-05 | [CopilotForXcode](https://github.com/intitni/CopilotForXcode) | 5090 | 🔠 🔨 `Swift`  | The missing GitHub Copilot, Codeium and ChatGPT Xcode Source Editor Extension |
| 2022-12-05 | [chatgpt_telegram_bot](https://github.com/karfly/chatgpt_telegram_bot) | 3936 | 🔠 🔨 `Python`  |  |
| 2022-12-05 | [chatgpt-mirai-qq-bot](https://github.com/lss233/chatgpt-mirai-qq-bot) | 8915 | 🔠 🔨 `Python`  | 🚀 一键部署！真正的 AI 聊天机器人！支持ChatGPT、文心一言、讯飞星火、Bing、Bard、ChatGLM、POE，多账号，人设调教，虚拟女仆、图片渲染、语音发送 \| 支持 QQ、Telegram、Discord、微信 等平台 |
| 2022-12-05 | [PyChatGPT](https://github.com/rawandahmad698/PyChatGPT) | 4167 | 🔠 🔨 `Python`  | ⚡️ Python client for the unofficial ChatGPT API with auto token regeneration, conversation tracking, proxy support and more. |
| 2022-12-04 | [Gepetto](https://github.com/JusticeRage/Gepetto) | 2315 | 🔠 🔨 `Python`  | IDA plugin which queries OpenAI's gpt-3.5-turbo language model to speed up reverse-engineering |
...
| 2022-12-04 | [chatgpt-chrome-extension](https://github.com/gragland/chatgpt-chrome-extension) | 2699 | 🔠 🔨 `JavaScript`  | A ChatGPT Chrome extension. Integrates ChatGPT into every text box on the internet. |
| 2022-12-04 | [chatgpt-telegram](https://github.com/m1guelpf/chatgpt-telegram) | 3808 | 🔠 🔨 `Go`  | Run your own GPTChat Telegram bot, with a single command! |
| 2022-12-04 | [chatgpt-google-extension](https://github.com/wong2/chatgpt-google-extension) | 13268 | 🔠 🔨 `TypeScript`  | This project is deprecated. Check my new project ChatHub: |
| 2022-12-03 | [ChatGPT](https://github.com/acheong08/ChatGPT) | 27207 | 🔠 🔨 `Python`  | Reverse engineered ChatGPT API |
| 2022-12-03 | [chatgpt-advanced](https://github.com/interstellard/chatgpt-advanced) | 5916 | 🔠 🔨 `TypeScript`  | WebChatGPT: A browser extension that augments your ChatGPT prompts with web results. |
| 2022-12-03 | [llm-workflow-engine](https://github.com/llm-workflow-engine/llm-workflow-engine) | 3458 | 🔠 🔨 `Python`  | Power CLI and Workflow manager for LLMs (core package) |
...
| 2022-12-03 | [chatgpt-api](https://github.com/transitive-bullshit/chatgpt-api) | 14932 | 🔠 🔨 `TypeScript`  | Node.js client for the official ChatGPT API. 🔥 |
| 2022-12-02 | [whatsapp-gpt](https://github.com/danielgross/whatsapp-gpt) | 3009 | 🔠 🔨 `Go`  |  |
...
| 2022-11-10 | [guidance](https://github.com/guidance-ai/guidance) | 12772 | 🔠 🔨 `Jupyter`  | A guidance language for controlling large language models. |
| 2022-11-02 | [llama_index](https://github.com/jerryjliu/llama_index) | 20812 | 🔠 🔨 `Python`  | LlamaIndex (GPT Index) is a data framework for your LLM applications |
| 2022-10-25 | [Learn_Prompting](https://github.com/trigaten/Learn_Prompting) | 3600 | 🔠 📝  |  |
...
| 2022-10-17 | [langchain](https://github.com/langchain-ai/langchain) | 60639 | 🔠 🔨 `Python`  | ⚡ Building applications with LLMs through composability ⚡ |
...
| 2022-10-03 | [trlx](https://github.com/CarperAI/trlx) | 3837 | 🔠 3️⃣  | A repo for distributed training of language models with Reinforcement Learning via Human Feedback (RLHF) |
| 2022-09-25 | [client](https://github.com/openai-php/client) | 3146 | 🔠 🔨 `PHP`  | ⚡️ OpenAI PHP is a supercharged community-maintained PHP API client that allows you to interact with OpenAI API. |
...
| 2022-09-18 | [ggml](https://github.com/ggerganov/ggml) | 6654 | 🔠 💡  | Tensor library for machine learning |
| 2022-09-17 | [CodeGeeX](https://github.com/THUDM/CodeGeeX) | 6823 | 🔠 🚕  | CodeGeeX: An Open Multilingual Code Generation Model (KDD 2023) |
...
| 2022-08-07 | [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) | 15457 | 🔠 🔨 `Python`  | Wechat robot based on ChatGPT,  which using OpenAI api and itchat library. 使用ChatGPT搭建微信聊天机器人，基于 GPT3.5/GPT4.0/Claude/文心一言/讯飞星火 模型，支持个人微信、公众号、企业微信部署，能处理文本、语音和图片，访问操作系统和互联网，支持基于知识库定制专属机器人。 |
